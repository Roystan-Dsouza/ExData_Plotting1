...
par(mfrow = c(2, 2))            #To place the plots row-wise in 2 rows and 2 columns

#Top-left plot
plot(datetime,electric_data$Global_active_power, type="l", xlab="", ylab="Global Active Power")

#Top-right plot
plot(datetime,electric_data$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
#Bottom-right plot
plot(datetime,electric_data$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
